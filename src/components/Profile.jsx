...
const Profile = () => {
  ...
  return (
    <div className="h-auto p-3 space-y-2 lg:w-40 md:w-60  sm:w-[600px] xs:w-[350px] dark:bg-gray-50 dark:text-gray-800 mt-16">
      <div className="flex items-center p-2 space-x-4">
        ...
        />
        <div>
          <h2 className="text-lg font-semibold">Ayushi Chauhan</h2>
